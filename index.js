...
module.exports = {
  ...
  treeFor: function (name) {
    if (_paceConfig && name === 'styles') {
      var paceThemeName = path.join(_paceConfig.color, 'pace-theme-' + _paceConfig.theme + '.css'),
          originalPaceThemePath = path.join(this.app.project.root, 'node_modules', PACE_DIR, 'themes', paceThemeName),
  ...
  contentFor: function (name) {
    if (_paceConfig && name === 'head') {
      var paceScriptPath = path.join(this.app.project.root, 'node_modules', PACE_DIR, 'pace.js'),
